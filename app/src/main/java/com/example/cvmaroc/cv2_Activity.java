...
public class cv2_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        setContentView(R.layout.cv_view2);
        ...
        grandview.setText(Html.fromHtml("<b>" + lsInfo.get(lsInfo.size() - 1).email + "</b>" +
