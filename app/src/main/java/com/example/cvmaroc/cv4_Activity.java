...
public class cv4_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        setContentView(R.layout.cv_view4);
        ...
        information.setText(Html.fromHtml( "<br>" + "<br>" + "<h4> Skills : </h4>"+strbuild + "</b>" + "<br>" + "<br>" + "<br>" + "<br>"+"<h4> Hobby : </h4>"+ st + "</b>"+ "<br>" +"<br>"+"<h4> Languages : </h4>"+ langues));
        ...
        grandview.setText(Html.fromHtml(
                "</b>" + "<br>" + "<br>" + "<br>" +
                        "<b>" + lsInfo.get(lsInfo.size() - 1).email + "</b>" +
                        "<br><b>" + lsInfo.get(lsInfo.size() - 1).contact + "</b>" +
                        "<br><b>" + lsInfo.get(lsInfo.size() - 1).city + "</b>" +
                        "<br><b>" + lsInfo.get(lsInfo.size() - 1).address +"<br>"+ "<br>" + "<br>" + "<br>" + "<br>" + "<br>"+ "<br>" + "<br>" + "<br>" + "<br>"+
                        strAbout +
                        Work1 +
                        Work2 +
                        Work3 +
