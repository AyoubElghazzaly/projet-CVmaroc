...
public class ShareActivity extends AppCompatActivity {
    ...
    private Button openmenudrawer,select;
...
// Set up DuoDrawerToggle to handle drawer open/close events
        ...
        pagehome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ShareActivity.this, mycvActivity.class);
        ...
        pageads.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ShareActivity.this, adsActivity.class);
                startActivity(intent);
            }
        });
        pagelanges.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ShareActivity.this, langue_Activity.class);
                startActivity(intent);       }
        });
